...
export default function InGameRank() {
    ...
    return (
        <div className='w-full h-full flex flex-col gap-3'>
            ...
            {
                myRecord.length > 0 && <div className="mt-9 border-b border-b-gray-500 pb-6">
            ...
            <div className="w-full flex justify-center items-center gap-3">
                ...
                />
                {/* Update Name */}
                <Button isIconOnly variant="ghost" className="text-white" size="lg" onClick={handleNameUpdate}><MdDoneOutline /></Button>
            </div>

            <div className="w-full flex justify-center items-center mt-3 gap-3">
                {/* Play Button */}
                <Button isIconOnly variant="ghost" className="text-white" size="lg" onClick={handleOnPlay} ><FaPlay /></Button>
                <Button isIconOnly variant="ghost" className="text-white text-2xl" size="lg" onClick={handleReset} ><GrPowerReset /></Button>
            </div>
            {/* Score */}
            {/* Name */}
            {/* Update? */}
